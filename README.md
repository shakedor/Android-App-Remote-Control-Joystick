...
# Prerequests
In order to connent to the Flight-Gear application, in the settings of the app, under the 'Additional Setting' add the line: "--telnet=socket,in,10,127.0.0.1,6400,tcp"
